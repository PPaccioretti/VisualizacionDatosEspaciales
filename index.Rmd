...
date: |
  `r icon::fa("at")` pablopaccioretti@agro.unc.edu.ar
  <br>`r icon::fa("at")` cebruno@agro.unc.edu.ar
output:
...
# .fancy[[https://github.com/PPaccioretti/VisualizacionDatosEspaciales]([https://github.com/PPaccioretti/VisualizacionDatosEspaciales)]
...
```{r, echo = FALSE, out.width = "10%", purl = FALSE}
